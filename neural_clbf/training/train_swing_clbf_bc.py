...
def main(args):
    ...
    if args.auto_red or args.red_method != "none":
        ...
        if args.auto_red:
            ...
            from neural_clbf.dimension_reduction.symplectic_projection import \
                SymplecticProjectionReducer as SPR
            from neural_clbf.dimension_reduction.opinf import OpInfReducer
            from neural_clbf.dimension_reduction.lyap_coherency import \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--auto_red", action="store_true",help="automatically choose among SP / OpInf / coherency")
    parser.add_argument("--red_method", default="none",choices=["none", "sp", "opinf", "lcr"],help="force a specific reduction method")
    parser.add_argument("--d_max", type=int, default=12,help="maximum latent dimension to consider")
